...
def test_plot_valid_inputs(gui, mocker):
    ...
    plotter.plot(self_of_gui_object=gui, function='x**2', min_value_of_x='0', max_value_of_x='10')
...
def test_plot_invalid_inputs(gui, mocker):
    ...
    mocker.patch.object(plotter, 'validate_fields', return_value=(1, '', '10'))
    ...
    # Call the function we want to test
    plotter.plot(self_of_gui_object=gui, function='x**2', min_value_of_x='', max_value_of_x='10')
